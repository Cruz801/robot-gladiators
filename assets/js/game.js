...
if (playerInfo.health > 0) {
    ...
    // pick new enemy to fight based on the index of the enemy.Info array
    var pickedEnemyObj = enemyInfo[i];

    //reset enemy.health before starting new fight
    pickedEnemyObj.health = randomNumber(40,60);

    // use debugger to pause script from running and what's going on at the moment in the code
   // debugger;
